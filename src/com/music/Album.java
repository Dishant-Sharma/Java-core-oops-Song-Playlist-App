...
//            System.out.println("Song with name "+ title + " already exists in the list");
    ...
    public boolean addToPlaylist(int trackNumber, LinkedList<Song> playList){
        int index = trackNumber - 1; // because index starts from zero
...
//        System.out.println("this album doesn't have song with track number: " + trackNumber);
    ...
    // user can add song to a playlsit with either track number or title
...
//        System.out.println(title + " there is no such song on the album");
        return false;
    }
}
